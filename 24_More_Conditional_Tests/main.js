...
console.log("string inequality false: ", "Shoaib" === "Rimaan");
//• Tests using the lower case function
console.log("lowerCase function true: ", "HELLO".toLowerCase() == "hello");
console.log("lowerCase function false: ", "HELLO" == "hello");
//• Numerical tests involving equality 
console.log("Numerical test equality value true: ", 23 == 23);
console.log("Numerical test inequality value false", 23 == 25);
// greater than
...
console.log("test using or operator: ", "password" == "password" || "Email" == "sk9952908@gmail.com");
console.log("test using or operator: ", "password" == "123" || "Email" == "sk9952908@gmail.com");
//• Test whether an item is in a array
var country = ["Pakistan", "Dubari", "Saudia", "Qatar", "India"];
if (country.includes("Pakistan")) {
    console.log("yes this country is in list");
}
//• Test whether an item is not in a array
var country_ = ["pakistan", "Dubari", "Saudia", "Qatar", "India"];

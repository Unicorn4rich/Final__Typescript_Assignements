...
let album1 = make_album('Sir Zia Khan', 'PIAIC');
console.log(album1);
let album2 = make_album('Sir Muhammad Qasim', 'Python Expert');
console.log(album2);
let album3 = make_album('Sir Daniyal nagori', 'CEO of Governer sindh IT initiative');
console.log(album3);
let album4 = make_album('Kamran tessori', 'Governer sindh', 2);
console.log(album4);
